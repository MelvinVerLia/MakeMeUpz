...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <asp:Button ID="MakeupInsertBtn" runat="server" Text="Insert Makeup" OnClick="MakeupInsertBtn_Click" />
    </div>
    <br />
    <div>
        ...
        <asp:GridView ID="MakeUpTypeGV" runat="server" AutoGenerateColumns="False" OnRowDeleting="MakeUpTypeGV_RowDeleting" OnRowEditing="MakeUpTypeGV_RowEditing">
         ...
         <asp:Button ID="TypeInsertBtn" runat="server" Text="Insert Makeup Type" OnClick="TypeInsertBtn_Click" />
    </div>
    <br />
    <div>
        ...
        <asp:Button ID="BrandInsertBtn" runat="server" Text="Insert Makeup Brand" OnClick="BrandInsertBtn_Click" />
    </div>
</asp:Content>
